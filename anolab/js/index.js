...
function init(){
	/*
	//提取单选题
	var obt = emb1.contentWindow.document;
	window.tbl = obt.getElementsByTagName("TABLE")[0];
	...
	//提取多选题
	var huo = emb2.contentWindow.document;
	window.frm = huo.getElementsByTagName("TABLE")[0];
